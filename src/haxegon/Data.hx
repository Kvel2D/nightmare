...
class Data {
    ...
    @:generic
    public static function blank2dVector<T>(width: Int, height: Int): Vector<Vector<T>> {
        var returnedvector2d: Vector<Vector<T>> = new Vector(width);
        for (i in 0...w)
        {
            returnedvector2d[i] = new Vector(h);
        }
        return returnedvector2d;
    }
}
#else
package haxegon;
...
class Data {
    ...
    public static function blank2dVector<T>(width: Int, height: Int): Vector<Vector<T>> {
        ...
        for (i in 0...width)
        {
            returnedvector2d[i] = new Vector(height);
        }
        return returnedvector2d;
    }
